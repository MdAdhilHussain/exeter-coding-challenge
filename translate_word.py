...
with open(r'C:\SpaceZee\t8.shakespeare.txt', 'r') as f:
    input_text = f.read()

with open(r'C:\SpaceZee\find_words.txt', 'r') as f:
    find_words = set(f.read().split())

with open(r'C:\SpaceZee\french_dictionary.csv', 'r') as f:
    reader = csv.reader(f)
...
with open(r'C:\SpaceZee\t8.shakespeare.translated.txt', 'w') as f:
    f.write(output_text)
...
with open(r'C:\SpaceZee\performance.txt', 'w') as f:
...
with open(r'C:\SpaceZee\frequency.csv', 'w') as f:
